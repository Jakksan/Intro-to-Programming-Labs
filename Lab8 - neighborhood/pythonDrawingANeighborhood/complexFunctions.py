...
drawTownSign(0, 200, "Nuketown")
drawTownSign(0, 100, "Villa")
drawTownSign(0, 0,  "Taumatawhakatangihangakoauauotamateapokaiwhenuakitanatahu")
drawTownSign(0, -100, "Highrise")
